  ...
  return (
    ...
    >
      ...
      <main className="pt-16">
        ...
        <section
          id="home"
          className="min-h-screen flex items-center px-4 sm:px-6 lg:px-8 xl:pl-32 xl:pr-16"
        >
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            >
              ...
              <p>
                ...
                <span className="text-white font-semibold">cloud-connected survey apps</span>. I enjoy tackling
                challenges that mix creativity with problem-solving and love learning new
                technologies along the way.
              </p>

              <p>
                I’m also diving deeper into{' '}
                <span className="text-white font-semibold">full-stack and cross-platform development</span>, while
                keeping an eye on modern best practices and how to build software that’s
        ...
        <section id="experience" className="py-32 px-4 sm:px-6 lg:px-8 bg-black">
          <div className="max-w-4xl mx-auto">
            <h3
              className="flex items-center text-2xl font-bold text-white mb-12"
              style={{ fontFamily: '"Inter", sans-serif' }}
            >
                  ...
                  <div className="space-y-6">
                    ...
                    >
                      <li className="flex items-start">
                        ...
                        Developing Python/C++ tools for TAR/ZIP analysis with content-defined chunking,
                        targeting around 30% duplicate data reduction.
                      </li>
                      <li className="flex items-start">
                        <span className="text-cyan-400 mr-4 mt-1 text-xl">▶</span>
                        Researching deduplication algorithms with Dr. Paul Lu, culminating in a seminar
                        and project report.
                      </li>
                    </ul>
                  </div>
                ...
                {activeExperience === 'daylily' && (
                  <div className="space-y-6">
                    ...
                    >
                      <li className="flex items-start">
                        <span className="text-cyan-400 mr-4 mt-1 text-xl">▶</span>
                        Collaborating with clients to gather requirements and translate them into tailored
                        AI-driven web solutions.
                      </li>
                      <li className="flex items-start">
                        <span className="text-cyan-400 mr-4 mt-1 text-xl">▶</span>
                        Building and deploying full-stack features to enhance customer engagement and
                        product scalability.
                      </li>
                    </ul>
                  </div>
                ...
                {activeExperience === 'iit-goa' && (
                  <div className="space-y-6">
                    ...
                    >
                      <li className="flex items-start">
                        <span className="text-cyan-400 mr-4 mt-1 text-xl">▶</span>
                        Developed 3+ control algorithms for flow battery management, reducing energy loss in
                        simulations by about 25%.
                      </li>
                      <li className="flex items-start">
                        <span className="text-cyan-400 mr-4 mt-1 text-xl">▶</span>
                        Collaborated on research for programmable flow systems, aiming for future IEEE
                        publication.
                      </li>
                    </ul>
                  </div>
                ...
                {activeExperience === 'ualberta' && (
                  <div className="space-y-6">
                    ...
                    >
                      <li className="flex items-start">
                        <span className="text-cyan-400 mr-4 mt-1 text-xl">▶</span>
                        Graded 400+ assignments and led 35 labs, contributing to a 15% improvement in student
                        averages.
                      </li>
                      <li className="flex items-start">
                        <span className="text-cyan-400 mr-4 mt-1 text-xl">▶</span>
                ...
                {activeExperience === 'natignite' && (
                  <div className="space-y-6">
                    ...
                    >
                      <li className="flex items-start">
                        <span className="text-cyan-400 mr-4 mt-1 text-xl">▶</span>
                        Built TrustLine, a real-time deepfake scam-call detector with React Native and
                        FastAPI.
                      </li>
                      <li className="flex items-start">
                        <span className="text-cyan-400 mr-4 mt-1 text-xl">▶</span>
                        Won 1st place and $6,000 in seed funding at the Network for Applied Technology (NAT)
                        AgeTech hackathon.
                      </li>
                    </ul>
                  </div>
                ...
                {activeExperience === 'devcon' && (
                  <div className="space-y-6">
                    ...
                    >
                      <li className="flex items-start">
                        <span className="text-cyan-400 mr-4 mt-1 text-xl">▶</span>
                        Built RideSafe, a real-time transit safety app with ViT-based threat detection using
                        React Native & Flask.
                      </li>
                      <li className="flex items-start">
                        <span className="text-cyan-400 mr-4 mt-1 text-xl">▶</span>
        ...
        <section id="work" className="py-32 px-4 sm:px-6 lg:px-8 bg-black">
          <div className="max-w-6xl mx-auto">
            <h3
              className="flex items-center text-2xl font-bold text-white mb-8"
              style={{ fontFamily: '"Inter", sans-serif' }}
            >
        ...
        <section id="contact" className="py-32 px-4 sm:px-6 lg:px-8 bg-black text-white">
          <div className="max-w-2xl mx-auto text-center">
            ...
            <p
              ...
              style={{ fontFamily: '"Inter", sans-serif' }}
            >
              I'm currently looking for internship opportunities and am always interested in
              collaborating on interesting projects. Whether you have an opportunity, a question,
